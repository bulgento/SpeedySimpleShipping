...
class BulGento_SpeedySimpleShipping_Helper_Picking_TakingDays
    extends Mage_Core_Helper_Abstract
{
    ...
    {
        $availableServices = new BulGento_SpeedySimpleShipping_Model_Picking_TakingDays($this->_getServiceApiHelper()->getService());
