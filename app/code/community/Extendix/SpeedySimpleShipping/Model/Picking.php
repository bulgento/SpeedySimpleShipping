...
class Extendix_SpeedySimpleShipping_Model_Picking
{
    ...
    /**
     * @param Extendix_SpeedySimpleShipping_Model_Picking_Sender $sender
     * @param Extendix_SpeedySimpleShipping_Model_Picking_Receiver $receiver
     * @param array $pickingData
     */
    public function __construct(
        Extendix_SpeedySimpleShipping_Model_Picking_Sender $sender,
        Extendix_SpeedySimpleShipping_Model_Picking_Receiver $receiver,
        array $pickingData
    ) {
