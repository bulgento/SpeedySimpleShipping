...
class Extendix_SpeedySimpleShipping_Model_Address
{

    /** @var Extendix_SpeedySimpleShipping_Model_Api_Service */
    protected $_speedyApiServiceModel;

    /** @var Extendix_SpeedySimpleShipping_Helper_Address_Cache */
    protected $_addressCacheHelper;

    function __construct(
        Extendix_SpeedySimpleShipping_Model_Api_Service $service,
        Extendix_SpeedySimpleShipping_Helper_Address_Cache $addressCacheHelper
    )
    {
